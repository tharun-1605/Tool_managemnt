  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [statsRes, toolsRes, myToolsRes, ordersRes, analyticsRes] = await Promise.all([
        axios.get('https://tool-managemnt.onrender.com/api/dashboard/stats', axiosConfig)
          .catch(err => {
            console.error('Stats API failed:', err);
            return { data: {} };
          }),
        axios.get('https://tool-managemnt.onrender.com/api/tools', axiosConfig)
          .catch(err => {
            console.error('Tools API failed:', err);
            return { data: [] };
          }),
        axios.get('https://tool-managemnt.onrender.com/api/tools/my-tools', axiosConfig)
          .catch(err => {
            console.error('My Tools API failed:', err);
            return { data: [] };
          }),
        axios.get('https://tool-managemnt.onrender.com/api/orders', axiosConfig)
          .catch(err => {
            console.error('Orders API failed:', err);
            return { data: [] };
          }),
        axios.get('https://tool-managemnt.onrender.com/api/usage/supervisor-analytics', axiosConfig)
          .catch(err => {
